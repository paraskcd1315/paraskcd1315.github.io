...
const PHONE_MOCKS = {
	...
	spotlight: {
		shots: ['/assets/spotlight-1.png', '/assets/spotlight-2.png', '/assets/spotlight-3.png'],
		background: 'linear-gradient(160deg, #0d1018, #14171f)',
		alt: 'Spotlight Search'
	},
	unitedwalls: {
		shots: ['/assets/unitedwalls-1.jpeg', '/assets/unitedwalls-2.jpeg', '/assets/unitedwalls-3.jpeg'],
